...
builder.Services.AddSwaggerGen(c =>
{
    c.SwaggerDoc("v1", new() { 
        ...
        Version = "v1",
        Description = "API for managing push notifications and device tokens"
    });
});
...
builder.Services.AddHealthChecks()
    .AddDbContextCheck<PushDbContext>("database");
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Push Service API v1");
