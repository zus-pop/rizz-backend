        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentMethodType = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    ...
                    PaymentMetadata = table.Column<string>(type: "text", nullable: false),
                    Status = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    StatusReason = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    StatusTimestamp = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ...
                    SubscriptionDuration = table.Column<int>(type: "integer", nullable: true),
                    ...
                    RefundExternalId = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    RefundProcessedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    RefundCreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    Refund_UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
